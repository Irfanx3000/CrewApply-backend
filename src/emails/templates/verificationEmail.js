...
<head>
  ...
  <title>Verify Your Email — CrewApply</title>
</head>
              ...
              <table cellpadding="0" cellspacing="0" style="margin:0 0 32px;">
                <tr>
                  <td style="background:#1a56db;border-radius:6px;">
                    <a href="${verificationUrl}" style="display:inline-block;padding:14px 32px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;">
                      Verify Email Address
                    </a>
                  </td>
                </tr>
              </table>
              <p style="margin:0 0 8px;color:#9ca3af;font-size:13px;">Or paste this link into your browser:</p>
              <p style="margin:0 0 24px;color:#6b7280;font-size:13px;word-break:break-all;">${verificationUrl}</p>
