...
const TEMPLATES = [
  {
    ...
    layout: {
      ...
      typography: { fontFamily: 'Roboto', baseFontSize: 10, headingScale: 1.4, lineHeight: 1.3 },
  ...
  },
  {
    ...
    description: 'Clean, general-purpose layout suitable for any role.',
    category: 'general',
    sortOrder: 20,
    layout: {
      page: { size: 'A4', margins: { top: 40, right: 40, bottom: 40, left: 40 }, columns: 1 },
      typography: { fontFamily: 'Roboto', baseFontSize: 10, headingScale: 1.3, lineHeight: 1.3 },
      colors: { primary: '#1E1E1E', secondary: '#556172', text: '#1E1E1E', muted: '#727272', divider: '#D9D9D9', background: '#FFFFFF' },
      spacing: { sectionGap: 14, itemGap: 6, blockPadding: 4 },
  ...
  },
  {
    ...
    description: 'Sparse, high-signal layout for senior ranks — minimal color, generous whitespace.',
    category: 'executive',
    sortOrder: 30,
    layout: {
      page: { size: 'A4', margins: { top: 50, right: 50, bottom: 50, left: 50 }, columns: 1 },
      typography: { fontFamily: 'Roboto', baseFontSize: 10, headingScale: 1.2, lineHeight: 1.4 },
      colors: { primary: '#000000', secondary: '#404040', text: '#1E1E1E', muted: '#727272', divider: '#BFBFBF', background: '#FFFFFF' },
      spacing: { sectionGap: 18, itemGap: 8, blockPadding: 4 },
      header: { style: 'centered', showPhoto: false, photoShape: 'circle' },
